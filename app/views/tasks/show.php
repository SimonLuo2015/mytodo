<ul id='actions'>
    ...
    <?php endif; ?>
    <li><a onclick="return confirm('Are you sure?')" href="<?php echo base_url(); ?>tasks/delete/<?php echo $task->list_id; ?>/<?php echo $this->uri->segment(3); ?>">Delete Tasks</a></li>
</ul>
...
<?php else: ?>
    <li>Stauts: <strong>Completed</strong></li>
<?php endif; ?>
